<?php 
    ...
    // update
    if($idx){
        $query = "SELECT * FROM others where idx='$idx' and pwd='$pwd' "; // update only when password matches
        ...
        $query = "UPDATE others SET contact='$contact',
        subject='$subject',
        price='$price',
        memo='$memo',
        image='$to'
        ...
        $query = "INSERT INTO others(contact, price, subject, memo, regdate, pwd, image)
