<?php
    ...
    $idx = $_GET['idx'];
    $query = "SELECT * FROM electronics where idx='$idx' ";
        ...
        <tr>
            <td colspan="2">
                <div style="float:right; ">
                    <a href="electronics_confirmDel.php?idx=<?=$idx?>">Delete</a>
                    <a href="electronics_write.php?idx=<?=$idx?>">Update</a>
                </div>

                <a href="electronics_list.php">Go back to list</a>
            </td>
        </tr>
    </table> 
</form> 
