<?php
    ...
    $idx = $_GET['idx'];
    $query = "SELECT * FROM home_appliances where idx='$idx' ";
        ...
        <tr>
            <td colspan="2">
                <div style="float:right; ">
                    <a href="home_appliances_confirmDel.php?idx=<?=$idx?>">Delete</a>
                    <a href="home_appliances_write.php?idx=<?=$idx?>">Update</a>
                </div>

                <a href="home_appliances_list.php">Go back to list</a>
            </td>
        </tr>
    </table> 
</form> 
