<?php 
    ...
    // update
    if($idx){
        $query = "SELECT * FROM books where idx='$idx' and pwd='$pwd' "; // update only when password matches
        ...
        $query = "UPDATE books SET contact='$contact',
        subject='$subject',
        price='$price',
        memo='$memo',
        image='$to'
        ...
        $query = "INSERT INTO books(contact, price, subject, memo, regdate, pwd, image)
