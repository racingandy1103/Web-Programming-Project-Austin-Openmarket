...
<head>
        ...
        <meta name="description" content="healthandbeauty">
...
<body>   
        ...
        <form action="healthandbeauty_search.php" method="post">
            <div style="float:right;">
                <label for="healthandbeauty_search">Search what you need:</label>
                <input type="text" id="healthandbeauty_search" name="skey">
        ...
        <span class = "title" style="color:grey; font-size:30px;">Health and Beauty</span>
        <a href="healthandbeauty_write.php">Post My Item</a> 
        ...
        <?php
            ...
            $query = "SELECT * FROM healthandbeauty WHERE subject like '%$user_skey%' ORDER BY idx DESC";
        ...
        ?>
            <tr>
                <td> <?=$data[idx]?> </td>
                <td> <a href="healthandbeauty_view.php?idx=<?=$data[idx]?>"><?=$data[subject]?><br>
